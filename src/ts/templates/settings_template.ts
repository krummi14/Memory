...
export function getCustomUnderlineTemplate(): string {
    return `
      <div class="settings_underline">
        <div class="settings_underline_square"></div>
        <div class="settings_underline_line"></div>
      </div>
  `;
}
...
export function getStartGameSectionTemplate(): string {
    return `
        <section class="start_game">
          ...
          <img
            id="startDefaultIcon"
            src="../assets/icons/start_disabled.svg"
            alt="Start Default Img"
          >
          ...
          >
            <img
              src="../assets/icons/start_button.svg"
              alt="Start Game Img"
            >
            Start
          </button>
